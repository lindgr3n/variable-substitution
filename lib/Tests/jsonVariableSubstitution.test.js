...
describe('Test JSON Variable Substitution', () => {
    ...
    it("Validate case sensitive variables is replaced", () => {
        (0, chai_1.expect)(jsonObject['User.Profile']).to.equal('replace_all');
    });
    ...
    it("Validate Object", () => {
        (0, chai_1.expect)(jsonObject['profile']['premiumLevel']).to.deep.equal({ "suaggar": "V4", "rok": "V5", "asranja": { "type": "V6" } });
    });
});
